...
assert.equal(SCREEN_SHARE_ULTRA_720_PROFILE.maxBitrate, 10_000_000, '720 + Ultra keeps the 10 Mbps Ultra bitrate ceiling');
assert.equal(
...
assert.equal(
  ...
  SCREEN_SHARE_ULTRA_720_PROFILE,
  '720 + Ultra selects the 10 Mbps 720p profile',
);
assert.equal(
