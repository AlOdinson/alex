...
assert.match(css, /\.toolbar-shell\s*\{[^}]*position:\s*fixed\s*!important/);
assert.match(css, /\.toolbar-shell\s*\{[^}]*inset:\s*0\s*!important/);
assert.doesNotMatch(css, /\.toolbar-shell\s*\{[^}]*width:\s*0\s*!important/);
assert.doesNotMatch(css, /\.toolbar-shell\s*\{[^}]*height:\s*0\s*!important/);
assert.match(css, /\.toolbar-shell\s*\{[^}]*pointer-events:\s*none/);
...
assert.match(css, /\.toolbar-status\s*\{[^}]*position:\s*static\s*!important/);
