...
assert(pyramidIcon.includes('strokeDasharray'), 'Pyramid icon must show the rear apex/base edge as hidden.');
...
assert(octahedronIcon.includes('M32 3L8 24L32 32L56 24Z'), 'Octahedron icon must show a perspective equator square.');
assert(octahedronIcon.includes('M32 45L8 24M32 45L32 32M32 45L56 24'), 'Octahedron icon must show the lower pyramid.');
