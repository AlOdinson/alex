...
export default function ShapeIcon({ id }) {
  switch (id) {
    ...
    case 'wire-cube': return <Common><path d="M9 15h34v27H9Z M9 15l9-9h34v27l-9 9 M43 15l9-9" /><path strokeDasharray="3 3" d="M18 6v27h34M18 33l-9 9" /></Common>;
    ...
    case 'pyramid': return <Common><path d="m32 4-24 37h46Z M32 4l8 28M8 41l32-9 14 9" /><path strokeDasharray="3 3" d="M32 4 20 32" /></Common>;
    ...
    case 'sphere': return <Common><circle cx="32" cy="24" r="20" /><path d="M12 24c0 5 9 9 20 9s20-4 20-9" /><path strokeDasharray="3 3" d="M12 24c0-5 9-9 20-9s20 4 20 9" /></Common>;
    ...
    case 'octahedron': return <Common><path d="m32 3 24 21-24 21L8 24Z M8 24h48" /><path strokeDasharray="3 3" d="M32 3v42" /></Common>;
