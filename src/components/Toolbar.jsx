...
function IconButton({
  ...
  const handlePointerDown = (event) => {
    ...
    // iPadOS can delay the synthetic click generated by Apple Pencil. Apply tool
    // changes on the physical contact itself so the next canvas pointerdown already
    // sees the new tool instead of spending one gesture on the previous mode.
